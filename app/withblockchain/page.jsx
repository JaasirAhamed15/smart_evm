...
export default function WithBlockchain() {
  ...
  const handleResetClick = () => {
    // redirct to flutterapp
    router.push("withblockchain/login");
  }

  const handleRegisterClick = () => {
    // redirct to flutterapp
    router.push("withblockchain/registerpage");
  }
    ...
    <div className="bg-[#0f172a] flex flex-col md:h-[100vh] md:flex-row justify-between items-center px-4 sm:px-10 py-16 md:py-20 gap-10">
      <div className="max-w-xl">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4">
          ...
          <button onClick={handleRegisterClick} className="cursor-pointer border border-blue-500 px-6 py-3 rounded-lg hover:bg-blue-600 transform hover:scale-110 transition-all duration-300 font-medium">
            Register Device
          </button>
        </div>
      </div>
